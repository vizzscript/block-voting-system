...
import { Box, Container, Paper, Typography, TextField, Button, InputAdornment, IconButton, Alert, Snackbar } from '@mui/material';
...
const Login = () => {
  ...
  useEffect(() => {
    if (isAuthenticated && role) {
      const from = location.state?.from?.pathname || (role === 'admin' ? '/admin/dashboard' : '/student/dashboard');
      navigate(from, { replace: true });
    }
  }, [isAuthenticated, role, navigate, location]);

  // Handle incoming Redux thunk errors
  useEffect(() => {
    if (error) {
        ...
        >
          <Box sx={{ textAlign: 'center', mb: 4 }}>
            ...
            <Typography variant="body2" sx={{ color: '#64748B' }}>
              Access the secure college voting portal
            </Typography>
          </Box>
